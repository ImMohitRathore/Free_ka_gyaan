...
const Quotes = () => {
    ...
    return (
        <>
         ...
         <div className="card3">
                 <h1 className="icon"> <i className="zmdi zmdi-quote"></i></h1>
                 <h2 className="icon2"> <i className="zmdi zmdi-quote"></i></h2>
                 ...
                 <button className="btn" onClick={change}><span class="notranslate">New Quotes</span></button>
                        <Link to="/">  <button className="btn" onClick={change}><span class="notranslate">New Gyaan</span></button> </Link>
                 </div>
         </div>
         <div className="footer">
      <a href="https://github.com/ImMohitRathore" className="git" > <img src={logo2} alt="" /> </a>
         </div>
        </>
    )
}
