    ...
    return (
        <>
           <div className="main">
            ...
            <button onClick={change}><span class="notranslate">New Gyaan</span></button>
          <Link to="/temp">  <button ><span class="notranslate">New Quotes</span></button></Link>
           </div>
